...
export const WORK = [
  {
    ...
    bullets: [
      ...
      { id: 'gov', text: 'Scoped and negotiated custom data feed terms for government-facing intelligence work, clearing complex procurement including general counsel redlines, CISO reviews, and federal requests for information (RFIs).' },
